...
// Silent Gallery – Landing Page Component
// TailwindCSS assumed. shadcn/ui optional (not required here to keep it portable).
// Export as default for easy drop-in under Next.js App Router.

export default function SilentGalleryLP() {
  const features = useMemo(
    () => [
      {
        title: "今を残さず、今を感じる。",
        body:
          "Silent Gallery は、1日1枚の無言の写真をそっと置く場所。写真は7日で流れ、反応も静かに消えます。評価や通知はありません。あるのは、光と静けさだけ。",
      },
      {
        title: "1日1枚・7日で流れる",
        body:
          "数ではなく質感を大切にする制限設計。TOPには7日以内の写真のみが並び、出会いの新鮮さを守ります。",
      },
      {
        title: "無言のリアクション",
        body:
          "🌙 🪶 💧 🔥 🌿 などの抽象的な反応で余韻だけを残す体験。数値ではなく、淡い“光”として写真に滲みます。",
      },
      {
        title: "静かなアーカイブ",
        body:
          "7日を過ぎた写真はTOPからは消え、あなたの個人ページに静かに積もっていきます。",
      },
    ],
    []
  );
    ...
    <div className="min-h-screen bg-[#0f1220] text-[#e9ecf1]">
      ...
      <header className="mx-auto max-w-6xl px-6 py-6 flex items-center justify-between">
        ...
        <nav className="hidden sm:flex items-center gap-6 text-sm opacity-80">
          <a href="#about" className="hover:opacity-100 transition-opacity">Concept</a>
      ...
      <section className="mx-auto max-w-6xl px-6 pt-12 pb-20">
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative h-[380px] md:h-[440px]">
            ...
            <FloatingCard delay={0} rotate={-2} src="https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?q=80&w=800&auto=format&fit=crop" />
            <FloatingCard delay={0.3} rotate={3} src="https://images.unsplash.com/photo-1508614999368-9260051291ea?q=80&w=800&auto=format&fit=crop" className="left-14 top-24" />
            <FloatingCard delay={0.6} rotate={-1} src="https://images.unsplash.com/photo-1501785888041-af3ef285b470?q=80&w=800&auto=format&fit=crop" className="right-4 top-36" />
          </div>
        </div>
      </section>
        ...
        <ol className="mt-6 grid md:grid-cols-3 gap-6 text-white/85">
          {[
            ...
            },
            {
              ...
              title: "漂って、現れる",
              body:
                "投稿はすぐ出ません。0〜3時間の“Drift”後にそっと現れます。TOPには7日以内の写真だけが並びます。",
            },
            {
              step: "3",
              title: "光だけが残る",
